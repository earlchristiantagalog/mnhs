...
export default function ICTLayout({
  ...
  const isActive = (href: string) => {
    if (href === "/ict") return pathname === "/ict";
      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 py-6 border-b border-white/10">
          ...
          <div>
            ...
            <div className="text-white/50 text-xs uppercase tracking-wider">ICT Portal</div>
          </div>
        </div>
              ...
              {profileOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden animate-[fadeUp_0.15s_ease_both] z-50">
                  <div className="px-4 py-3 border-b border-gray-100">
                    <div className="text-sm font-bold text-gray-800">ICT Coordinator</div>
                    <div className="text-[11px] text-gray-400">ict@mnhs.edu</div>
                  </div>
                  <div className="py-1">
                    <Link
                      href="/ict/profile"
